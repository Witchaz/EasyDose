      ...
      <ThemedView>
        <Container>
          <Card
            ...
            image="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Common_Snapping_Turtle_Close_Up.jpg/1280px-Common_Snapping_Turtle_Close_Up.jpg"
            cardKey={key}
            setCardKey={setKey}
          />
          <Card
            medecine_name="ยา 2"
            description="ทานครั้งละ 1 เม็ด"
          ...
          <Card
            medecine_name="ยา 4"
            description="ทานครั้งละ 0.5 เม็ด"
            image="https://hololive.hololivepro.com/wp-content/uploads/2023/04/Minato-Aqua_pr-img_01b.png"
            cardKey={key}
            setCardKey={setKey}
          />
